...
REPLACE INTO `mf_menu` VALUES
(1,0,'Admin','Menu','index','显示','菜单管理','fa-tasks',0),
(2,1,'Admin','Menu','search','隐藏','搜索菜单','',0),
(3,1,'Admin','Menu','add','隐藏','添加菜单','',0),
(4,1,'Admin','Menu','addPost','隐藏','菜单表单添加提交','',0),
(5,1,'Admin','Menu','del','隐藏','删除菜单','',0),
(6,1,'Admin','Menu','bdel','隐藏','批量删除菜单','',0),
(7,1,'Admin','Menu','save','隐藏','修改菜单','',0),
(8,1,'Admin','Menu','savePost','隐藏','菜单表单修改提交','',0),
(9,0,'Admin','Role','index','显示','角色管理','fa-user-md',0),
(10,9,'Admin','Role','search','隐藏','搜索角色','',0),
(11,9,'Admin','Role','add','隐藏','添加角色','',0),
(12,9,'Admin','Role','addPost','隐藏','角色表单添加提交','',0),
(13,9,'Admin','Role','del','隐藏','删除角色','',0),
(14,9,'Admin','Role','bdel','隐藏','批量删除角色','',0),
(15,9,'Admin','Role','save','隐藏','修改角色','',0),
(16,9,'Admin','Role','savePost','隐藏','角色表单修改提交','',0),
(17,0,'Admin','Admin','index','显示','管理员','fa-user',0),
(18,17,'Admin','Admin','search','隐藏','搜索管理员','',0),
(19,17,'Admin','Admin','add','隐藏','添加管理员','',0),
(20,17,'Admin','Admin','addPost','隐藏','管理员表单添加提交','',0),
(21,17,'Admin','Admin','del','隐藏','删除管理员','',0),
(22,17,'Admin','Admin','bdel','隐藏','批量删除管理员','',0),
(23,17,'Admin','Admin','save','隐藏','修改管理员','',0),
(24,17,'Admin','Admin','savePost','隐藏','管理员表单修改提交','',0),
(25,0,'Admin','Music','index','显示','音乐管理','fa-music',0),
(26,25,'Admin','Music','search','隐藏','搜索音乐','',0),
(27,25,'Admin','Music','add','隐藏','添加音乐','',0),
(28,25,'Admin','Music','addPost','隐藏','音乐表单添加提交','',0),
(29,25,'Admin','Music','del','隐藏','删除音乐','',0),
(30,25,'Admin','Music','bdel','隐藏','批量删除音乐','',0),
(31,25,'Admin','Music','save','隐藏','修改音乐','',0),
(32,25,'Admin','Music','savePost','隐藏','音乐表单修改提交','',0),
(33,0,'Gii','Index','index','显示','代码生成器','fa-code',0),
(34,0,'Gii','Index','analyze','隐藏','分析菜单','',0),
(35,0,'Gii','Index','buildMenu','隐藏','生成菜单','',0);
...
REPLACE INTO `mf_role` VALUES (1,'超级管理员','*','拥有网站最高管理权限！',now(),0);

CREATE TABLE IF NOT EXISTS `mf_music` (
